...
function playdate.accessibility() end
function playdate.playdate.getReduceFlashing() end
function playdate.playdate.getFlipped() end
...
function playdate.playdate.setCrankSoundsDisabled(disable) end
function playdate.inputHandlers() end
function playdate.inputHandlers.push(handler, masksPreviousHandlers) end
function playdate.inputHandlers.pop() end
function playdate.autoLock() end
function playdate.playdate.setAutoLockDisabled(disable) end
...
function playdate.debug() end
function playdate.print(string) end
function playdate.printTable(table) end
...
function playdate.where() end
function playdate.profiling() end
function playdate.playdate.getStats() end
function playdate.playdate.setStatsInterval(seconds) end
function playdate.display() end
...
function playdate.easingFunctions() end
function playdate.easingFunctions(t, b, c, d) end
function playdate.datastore() end
...
function playdate.geometry() end
function playdate.geometry.affineTransform() end
...
function playdate.geometry.arc() end
...
function playdate.geometry.lineSegment() end
...
function playdate.geometry.lineSegment.fast.intersection(x1, y1, x2, y2, x3, y3, x4, y4) end
...
function playdate.geometry.point() end
...
function playdate.geometry.polygon() end
...
function playdate.geometry.rect() end
...
function playdate.geometry.size() end
...
function playdate.geometry.vector2D() end
...
function playdate.graphics() end
...
function playdate.graphics.image() end
...
function playdate.graphics.animation.loop() end
...
function playdate.graphics.animator() end
...
function playdate.graphics.animation.blinker() end
...
function playdate.graphics.imagetable() end
...
function playdate.graphics.tilemap() end
...
function playdate.graphics.sprite() end
...
function playdate.graphics.sprite.setBounds(upper-left-x, upper-left-y, width, height) end
...
function playdate.graphics.font() end
...
function playdate.keyboard() end
...
function playdate.math() end
function playdate.math.lerp(min, max, t) end
function playdate.pathfinder() end
function playdate.playdate.pathfinder.graph() end
...
function playdate.playdate.pathfinder.graph.addConnections(connections) end
function playdate.playdate.pathfinder.graph.addConnectionToNodeWithID(fromNodeID, toNodeID, weight, addReciprocalConnection) end
function playdate.playdate.pathfinder.graph.removeAllConnections() end
function playdate.playdate.pathfinder.graph.removeAllConnectionsFromNodeWithID(id, removeIncoming) end
...
function playdate.playdate.pathfinder.graph.setXYForNodeWithID(id, x, y) end
function playdate.playdate.pathfinder.node() end
...
function playdate.sound() end
function playdate.sound.getSampleRate() end
function playdate.sound.sampleplayer() end
...
function playdate.sound.fileplayer() end
...
function playdate.sound.sample() end
...
function playdate.sound.channel() end
...
function playdate.sound.source() end
function playdate.sound.playingSources() end
function playdate.sound.synth() end
function playdate.sound.synth.new.waveform(waveform) end
function playdate.sound.synth.new.sample(sample, sustainStart, sustainEnd) end
...
function playdate.sound.envelope() end
...
function playdate.sound.ringmod() end
...
function playdate.sound.onepolefilter() end
...
function playdate.sound.twopolefilter() end
...
function playdate.sound.overdrive() end
...
function playdate.sound.delayline() end
function playdate.sound.delayline.setMix(level) end
function playdate.sound.delayline.setMixMod(signal) end
function playdate.sound.delayline.addTap(delay)(delay) end
function playdate.sound.delayline.setFeedback(level)(level) end
function playdate.sound.delaylinetap() end
...
function playdate.sound.delaylinetap.setFlipChannels(flag)(flag) end
function playdate.sound.sequence() end
...
function playdate.sound.track() end
...
function playdate.sound.instrument() end
...
function playdate.sound.controlsignal() end
...
function playdate.frameTimer() end
...
function playdate.ui() end
function playdate.crankIndicator.start() end
function playdate.crankIndicator.update() end
function playdate.crankIndicator.clockwise() end
function playdate.gridview.drawCell(section, row, column, selected, x, y, width, height) end
function playdate.gridview.drawSectionHeader(section, x, y, width, height) end
function playdate.gridview.drawHorizontalDivider(x, y, width, height) end
function playdate.gridview.drawInRect(x, y, width, height) end
function playdate.gridview.needsDisplay() end
function playdate.gridview.setNumberOfSections(num) end
function playdate.gridview.getNumberOfSections() end
function playdate.gridview.setNumberOfRowsInSection(section, num) end
function playdate.gridview.getNumberOfRowsInSection(section) end
function playdate.gridview.setNumberOfColumns(num) end
function playdate.gridview.getNumberOfColumns() end
function playdate.gridview.setNumberOfRows(...) end
function playdate.gridview.setCellSize(cellWidth, cellHeight) end
function playdate.gridview.setCellPadding(left, right, top, bottom) end
function playdate.gridview.setContentInset(left, right, top, bottom) end
function playdate.gridView.getCellBounds(section, row, column, gridWidth) end
function playdate.gridview.setSectionHeaderHeight(height) end
function playdate.gridview.getSectionHeaderHeight() end
function playdate.gridview.setSectionHeaderPadding(left, right, top, bottom) end
function playdate.gridview.setHorizontalDividerHeight(height) end
function playdate.gridview.getHorizontalDividerHeight() end
function playdate.gridview.addHorizontalDividerAbove(section, row) end
function playdate.gridview.removeHorizontalDividers() end
function playdate.gridview.setScrollDuration(ms) end
function playdate.gridview.setScrollPosition(x, y, animated) end
function playdate.gridview.getScrollPosition() end
function playdate.gridview.scrollToCell(section, row, column, animated) end
function playdate.gridview.scrollCellToCenter(section, row, column, animated) end
function playdate.gridview.scrollToRow(row, animated) end
function playdate.gridview.scrollToTop(animated) end
function playdate.gridview.setSelection() end
function playdate.gridview.getSelection() end
function playdate.gridview.setSelectedRow(row) end
function playdate.gridview.getSelectedRow() end
function playdate.gridview.selectNextRow(wrapSelection, scrollToSelection, animate) end
function playdate.gridview.selectPreviousRow(wrapSelection, scrollToSelection, animate) end
function playdate.gridview.selectNextColumn(wrapSelection, scrollToSelection, animate) end
function playdate.gridview.selectPreviousColumn(wrapSelection, scrollToSelection, animate) end
function playdate.gridview.backgroundImage() end
function playdate.gridview.isScrolling() end
function playdate.gridview.scrollEasingFunction() end
function playdate.gridview.easingAmplitude() end
function playdate.gridview.easingPeriod() end
function playdate.gridview.changeRowOnColumnWrap() end
function playdate.gridview.scrollCellsToCenter() end
